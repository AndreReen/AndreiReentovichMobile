...
public class Artifact {
    ...
    public String toString() {
        ...
        sb.append("apk");
        sb.append('=');
        sb.append(((this.apk == null)?"<null>":this.apk));
        sb.append(',');
        sb.append("ipa");
        sb.append('=');
        sb.append(((this.ipa == null)?"<null>":this.ipa));
        sb.append(',');
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.ipa == null)? 0 :this.ipa.hashCode()));
        ...
        result = ((result* 31)+((this.apk == null)? 0 :this.apk.hashCode()));
        return result;
    }
    ...
    public boolean equals(Object other) {
        ...
        return (((((((((((((((this.verified == rhs.verified)||((this.verified!= null)&&this.verified.equals(rhs.verified)))&&((this.realName == rhs.realName)||((this.realName!= null)&&this.realName.equals(rhs.realName))))&&((this._private == rhs._private)||((this._private!= null)&&this._private.equals(rhs._private))))&&((this.name == rhs.name)||((this.name!= null)&&this.name.equals(rhs.name))))&&((this.checksum == rhs.checksum)||((this.checksum!= null)&&this.checksum.equals(rhs.checksum))))&&((this.alias == rhs.alias)||((this.alias!= null)&&this.alias.equals(rhs.alias))))&&((this.contentLength == rhs.contentLength)||((this.contentLength!= null)&&this.contentLength.equals(rhs.contentLength))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.href == rhs.href)||((this.href!= null)&&this.href.equals(rhs.href))))&&((this.ipa == rhs.ipa)||((this.ipa!= null)&&this.ipa.equals(rhs.ipa))))&&((this.bid == rhs.bid)||((this.bid!= null)&&this.bid.equals(rhs.bid))))&&((this.uploadedBy == rhs.uploadedBy)||((this.uploadedBy!= null)&&this.uploadedBy.equals(rhs.uploadedBy))))&&((this.contentType == rhs.contentType)||((this.contentType!= null)&&this.contentType.equals(rhs.contentType))))&&((this.apk == rhs.apk)||((this.apk!= null)&&this.apk.equals(rhs.apk))));
    }
